...
import com.example.chatapplication.action.ActivityAction
import com.example.chatapplication.action.AnimAction
import com.example.chatapplication.action.ClickAction
import com.example.chatapplication.action.HandlerAction
import com.example.chatapplication.action.KeyboardAction
import com.example.chatapplication.action.ResourcesAction
import java.lang.ref.SoftReference
import java.util.*

@Suppress("LeakingThis")
open class BaseDialog constructor(context: Context, @StyleRes themeResId: Int = R.style.BaseDialogTheme) :
    AppCompatDialog(context, themeResId), ActivityAction, ResourcesAction,
