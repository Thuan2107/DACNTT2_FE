...
public class BottomNavBar extends RelativeLayout implements View.OnClickListener {
    ...
    public void setBottomNavBarStyle() {
        ...
        bottomBarStyle.setBottomPreviewNormalTextColor(R.color.white);
...
//        bottomBarStyle.setBottomEditorTextColor(R.color.white);
...
//            tvImageEditor.setTextColor(editorTextColor);
            tvImageEditor.setTextColor(ContextCompat.getColor(getContext(), R.color.white));
    ...
    public void setSelectedChange() {
        ...
        if (config.getSelectCount() > 0) {
            ...
            if (StyleUtils.checkStyleValidity(previewNormalTextColor)) {
                ...
                tvPreview.setTextColor(ContextCompat.getColor(getContext(), R.color.white));
            }
